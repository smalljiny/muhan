 ...
 *
 * `_actor`는 CommandHandler 계약이 넘기는 행위자 컨텍스트다 — 무권한 진단 핸들러라 소비하지 않는다.
 */
export function echoHandler(command: ClientCommand, _actor: ActorContext): ServerEvent | undefined {
